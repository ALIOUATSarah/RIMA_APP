      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4 scrollbar-hide">
        {project.messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center opacity-30 text-center px-12">
            <h3 className="text-xl font-bold mb-2 font-branding tracking-widest uppercase text-white/50">Neural Link Active</h3>
            <p className="text-sm font-light">Rima Agent is monitoring this workspace.</p>
          </div>
        )}
